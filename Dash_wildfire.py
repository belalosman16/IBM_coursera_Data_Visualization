...
app.layout=html.Div(children=[html.H1("Australia Wild fire Dashboard" ,style={'textAlign':'center' , 'color': '#503D36', 'font-size': 40}),
                              html.Div([
                                    html.Div([
                                    ...
                                    html.Div([
                                        ...
                                        dcc.Dropdown(df.Year.unique(), value = 2005,id='year',placeholder="Enter year")
